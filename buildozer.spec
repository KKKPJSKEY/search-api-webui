...
title = Search API WebUI

# (str) Package name
package.name = searchapiwebui

# (str) Package domain (needed for android/ios packaging)
package.domain = ai.querit
...
# use that parameter together with android.services
...
# 1) android.add_assets = source_dir/sub_dir/file.txt
# 2) android.add_assets = source_dir/sub_dir:dest_dir/sub_dir
#android.add_assets =
...
# android.add_resources = legal_icons/icon.png:drawable/icon.png
# 2) A directory, here  'legal_resources' must contain resources of one kind
# android.add_resources = legal_resources:drawable
...
# (str) The Android package format to build for, choices: aab, apk (default: apk)
# Note that 'aab' format is necessary for Play Store compatibility.
